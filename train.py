...
flags.DEFINE_enum(
    "mode", "fit", ["fit", "eager_tf"], "fit: model.fit, eager_tf: custom GradientTape"
)
...
def main(_):
    ...
    if FLAGS.mode == "eager_tf":
        ...
        while epochs <= cfg["epochs"]:
            ...
            if steps % 5 == 0:
                ...
                with summary_writer.as_default():
                    tf.summary.scalar("loss/total loss", total_loss, step=steps)
        ...
        tb_callback = TensorBoard(
            log_dir="logs/", update_freq=cfg["batch_size"] * 5, profile_batch=0
        )
